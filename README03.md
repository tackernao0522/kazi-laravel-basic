...
## Admin Panel Setup Part2

+ `resources/views/admin/admin_master.blade.php`を作成<br>
...
+ `resources/views/admin/index.blade.php`を作成<br>

+ `public/backend`ディレクトリを作成<br>

+ `public/frontend`ディレクトリを作成<br>
        ...
        <nav class="navbar navbar-static-top navbar-expand-lg">
          ...
          <div class="navbar-right ">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user-menu">
                <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  <img src="{{ asset('backend/assets/img/user/user.png') }}" class="user-image" alt="User Image" /> // 編集
                  <span class="d-none d-lg-inline-block">Abdus Salam</span>
                </button>
                <ul class="dropdown-menu dropdown-menu-right">
                  <!-- User image -->
...
## Admin Panel Setup Part3

+ `resources/views/admin/body`ディレクトリを作成<br>

+ `resources/views/admin/body/sidebar.blade.php`を作成<br>
  ...
  <div id="sidebar" class="sidebar sidebar-with-footer">
    ...
    <div class="app-brand">
      <a href="/index.html">
        ...
        <span class="brand-name">Admin Dashboard</span> // 編集
      </a>
    </div>
    <!-- begin sidebar scrollbar -->
    <div class="sidebar-scrollbar">
