...
Route::get('/about', function () {
    return view('about'); // 元に戻す
});

Route::get('/contact', [ContactController::class, 'index'])->name('contact'); // 編集
```

+ `welcome.blade.php`を編集<br>
...
## Laravel8 Authentication Details
...
+ `navigation-menu.blade.php`を編集<br>
...
+ `create_categories_table.php`ファイルを編集<br>
...
+ `$ php artisan make:controller CategoryController`<br>
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('all.category') }}"> // 編集
                        All Category
                    </x-jet-nav-link>
                </div>
            </div>
...
+ `resources/views/admin/category`ディレクトリを作成<br>

+ `resources/views/admin/category/index.blade.php`ファイルを作成<br>
...
+ `views/admin/category/index.blade.php`を編集<br>
...
+ `resources/views/admin/category/edit.blade.php`を作成<br>
...
## Soft Delete, Data Restore & ForceDelete Part2
...
+ `$ php artisan make:model Brand -m`を実行<br>

+ `$ php artisan make:controller BrandController`を実行<br>
...
+ `resources/views/admin/brand`ディレクトリを作成<br>

+ `resources/views/admin/brand/index.blade.php`を作成<br>

+ `create_Brands_table.php`を編集<br>
