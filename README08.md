  ...
  <div class="container d-flex align-items-center">
    ...
    <nav class="nav-menu d-none d-lg-block">
      <ul>
        ...
        <li><a href="{{ route('portfolio') }}">Portfolio</a></li> // 編集
...
+ `resources/views/pages`ディレクトリを作成<br>

+ `resources/views/pages/portfolio.blade.php`ファイルを作成<br>
...
+ `resources/views/layouts/master.blade.php`を編集<br>

```
@include('layouts.body.slider')の部分を削除する
```
...
```
@extends('layouts.master_home')
@include('layouts.body.slider') // 追記
...
+ `resources/views/pages/portfolio.blade.php`を編集<br>
